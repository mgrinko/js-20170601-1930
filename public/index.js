...
var _phonePage = __webpack_require__(6);
...
var _phoneViewer = __webpack_require__(30);
...
var PhonePage = function () {
  ...
  _createClass(PhonePage, [{
    ...
    key: '_showPhones',
    value: function _showPhones(phonesFromServer) {
...
var PhoneCatalogue = function (_Component) {
  ...
  function PhoneCatalogue(options) {
    ...
    _this.on('click', _this._onPhoneClick.bind(_this), '[data-element="phone"]');
    return _this;
  }
...
var PhoneViewer = function (_Component) {
  ...
  function PhoneViewer(options) {
    ...
    _this.on('click', _this._onBackButtonClick.bind(_this), '[data-element="back-button"]');
    _this.on('click', _this._onAddButtonClick.bind(_this), '[data-element="add-button"]');
    return _this;
  }

  _createClass(PhoneViewer, [{
    key: 'setPhone',
    value: function setPhone(phoneDetails) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<h4>Shopping cart</h4>\n\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = (depth0 != null ? depth0.products : depth0)) != null ? stack1.length : stack1),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "");
},"useData":true,"useBlockParams":true});
